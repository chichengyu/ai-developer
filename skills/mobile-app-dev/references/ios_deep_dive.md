...
Read this when Step 1.5 has picked Swift / SwiftUI / UIKit and you
need platform-specific patterns. For the workflow + framework
comparison, see the main `SKILL.md`.
